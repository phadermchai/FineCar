            ...
            <div class="row">
                        ...
                        <div class="card-group">
                            <?php echo '<div class="card"><img class="card-img-top w-100 d-block" src="'.$rowCar['CarPic'].'">'; ?>
                                <div class="card-body">
                                    ...
                                    <p class="card-text">&nbsp;<?php echo $rowCar['CarSeat'] ?> ที่นั่ง | <?php echo $rowCar['CarDoor'] ?> ประตู | เกียร์ <?php echo $rowCar['CarGear'] ?>&nbsp;<br></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <form>
                        ...
                        <p style="font-size:25px;">ค่าเช่ารถ THB <?php echo $rowCar['CarCost'] ?> x <?php echo $DayRent ?> วัน &nbsp; &nbsp; &nbsp; &nbsp;THB <?php echo $row['B_Cost']; ?></p>
                        <p style="font-size:25px;">ค่าบริการคนขับ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; THB 200</p>
                        <p style="font-size:25px;">รวม &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; THB <?php echo $row['B_Cost'] + 200; ?></p>
                        <p>เช่าวันที่: <?php echo $row['B_DateStart']?>  ถึงวันที่: <?php echo $row['B_DateEnd']?> </p>
                        <p>ชื่อคนขับ: <?php echo $rowDriver['D_Firstname']; echo " ";  echo $rowDriver['D_Lastname'];?>  อายุ: <?php echo $rowDriver['D_Age']?> </p>
                        <div class="form-group"><a class="btn btn-primary" role="button" href="CarDetail-4.php" style="width:100%;">ถัดไป</a></div>
                    </form>
                </div>
            </div>
        </div>
